...
import com.bnpp.ism.dao.storage.StorageDao;
import com.bnpp.ism.dao.storage.StoredFileDao;
...
@Service
public class DefaultStorageSetManager implements IDefaultStorageSetManager {
	@Autowired

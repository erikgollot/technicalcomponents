...
public class TechnicalComponent {
	...
	public String getFullPathname() {
		return getCategory().getFullPathname() + "/" + getMyName();
	}

	private String getMyName() {
		if (getLocalInformations() != null) {
			return getLocalInformations().getName();
		} else if (getVendorInformations() != null) {
			return getVendorInformations().getName();
		} else {
			return "not named component";
		}
	}
}
